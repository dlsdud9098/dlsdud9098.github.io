...
![png](/assets/img/main2_files/main2_11_0.png)
...
![png](/assets/img/main2_files/main2_12_1.png)
...
![png](/assets/img/main2_files/main2_21_0.png)
...
![png](/assets/img/main2_files/main2_34_0.png)
...
![png](/assets/img/main2_files/main2_37_0.png)
...
```
    ...
    /tmp/ipykernel_4687/3071742329.py:7: UserWarning: set_ticklabels() should only be used with a fixed number of ticks, i.e. after set_ticks() or using a FixedLocator.
      f.set_xticklabels(f.get_xticklabels(), rotation=90) # x라벨 90회전



    
![png](/assets/img/main2_files/main2_39_1.png)
...
'''
하지만 위에서 봤듯이 OPS가 그나마 중앙에 모여있는 2005년 이전(사실 대부분)이 데이터의 수가 매우 적다.
''';
```


    
![png](/assets/img/main2_files/main2_43_0.png)
