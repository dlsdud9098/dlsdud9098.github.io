...
```
    ...
    ['Pre_Season_Batter.csv',
     ...
     'Regular_Season_Batter copy.csv',
     'submission.csv',
...
```
    ...
    ---  ------           --------------  -----  
     ...
     20  SLG              1393 non-null   float64
     21  OBP              1393 non-null   float64
...
![png](/assets/img/main5_files/main5_10_0.png)
...
![png](/assets/img/main5_files/main5_11_1.png)
...
![png](/assets/img/main5_files/main5_23_0.png)
...
![png](/assets/img/main5_files/main5_37_0.png)
...
![png](/assets/img/main5_files/main5_40_0.png)
...
```
    ...
    /tmp/ipykernel_8701/3071742329.py:7: UserWarning: set_ticklabels() should only be used with a fixed number of ticks, i.e. after set_ticks() or using a FixedLocator.
      f.set_xticklabels(f.get_xticklabels(), rotation=90) # x라벨 90회전



    
![png](/assets/img/main5_files/main5_41_1.png)
...
![png](/assets/img/main5_files/main5_45_0.png)
...
```
    ...
    /home/apic/python/kbo_ops_predict/batter_height_weight_position_insert.py:121: FutureWarning: Passing literal html to 'read_html' is deprecated and will be removed in a future version. To read from a literal string, wrap it in a 'StringIO' object.
...
![png](/assets/img/main5_files/main5_50_0.png)
...
```
    ...
    Cell In[127], line 35
         33 x_center = (x_max / 2) + x_min  # 박스의 중앙 x좌표 계산
         34 # 중앙값 가져오기
    ---> 35 hand = patch.get_x()  # 각 박스에 해당하는 x값 (hand 값을 얻기)
         36 value = median.get(hand, None)  # 해당 hand 값에 대한 중앙값 가져오기
         38 if value is not None:  # 중앙값이 존재하는 경우에만 텍스트 추가
...
![png](/assets/img/main5_files/main5_53_1.png)
...
![png](/assets/img/main5_files/main5_54_1.png)
